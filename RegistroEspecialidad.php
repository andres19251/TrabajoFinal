...
<div class="text-center">
       ...
       <div class="col-12">
        ...
        <form action="" class="col-12 formulario">
            <h1 style="margin-left: 0%;" align="center"><font face="Arial">AGREGAR CITA</font></h1>
            <hr>
            <label  for="">CODIGO <font color="red">*</font></label><br>
            ...
            <input class="bg-warning" type="submit" value="AGREGAR"> <br><br><br><br><br>
