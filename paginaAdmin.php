...
<body>
    ...
    <div class="text-center">
        ...
        <div class="d-flex">
            ...
            <div class="col-md-9">
                <br>
                <h2><font>LISTA DE ADMINISTRADORES</font></h2>
                <a style="text-align: right;" href="RegistroAdmin.php" class="btn btn-success">AGREGAR NUEVO ADMINISTRADOR</a> <br><br><br>
                <table class="table">
