...
<head>
    ...
    <link rel="stylesheet" href="../CSS/paginaEspecialidades.css">
...
<body>
    ...
    <div class="text-center">
        ...
        <div class="d-flex">
            ...
            <div class="col-md-9">
            <br>
                <h2><font>LISTA DE ESPECIALIDADES</font></h2>

                <a style="text-align: right;" href="RegistroEspecialidad.php" class="btn btn-success">AGREGAR NUEVA ESPÉCIALIDAD</a> <br><br><br>

                <table class="table">
                    <thead class="table-success table-striped">
                        <tr>
                            <th>Codigo ESPECIAL</th>
