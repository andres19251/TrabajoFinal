...
<head>
    ...
    <link rel="stylesheet" href="../CSS/paginaEmpleado.css">
...
<body>
    ...
    <div class="text-center">
        ...
        <div class="d-flex">
            ...
            <div class="col-md-9">
            <br>
                <h2><font>LISTA DE EMPLEADOS</font></h2>

                <a style="text-align: right;" href="RegistroEmpleado.php" class="btn btn-success">AGREGAR NUEVO EMPLEADO</a> <br><br><br>
