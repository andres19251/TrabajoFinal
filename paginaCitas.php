...
<head>
    ...
    <title>Avan Salud/Iniciar Sesión/Administrador/Citas</title>

    <link rel="stylesheet" href="../CSS/paginaCitas.css">
                        ...
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item navegar">
                                <a class="nav-link" href="inicio.html">
                                    <font color="white" size="5%">Inicio</font>
                                </a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link navegar" href="reservar_cita.php">
                                    <font color="white" size="5%">Reservar Cita</font>
                                </a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="d-flex">
            ...
            <div id="sidebar-container" class="bg-primary">
                ...
                <div class="menu" style="text-align: left;">
                    ...
                    <a href="pag" class="d-block text-light p-4 lateral"><i class="fa-solid fa-calendar-plus mr-2 lead"></i> Citas</a>
                </div>
            </div>
