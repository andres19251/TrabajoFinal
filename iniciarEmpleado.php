...
<head>
    ...
    <link rel="stylesheet" href="../CSS/iniciar_sesion_2.css">
    ...
    <div class="text-center">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="iniciarEmpleado.php">
        ...
        <div>
            ...
            <div class="col-12 formulario">
                ...
                <form action="iniciarEmpleado.php" method="POST">
                    <hr>
                    <legend class="col-12"><font face="Cooper Black" size="6%">EMPLEADO</font></legend>
                    <img class="img-fluid" src="..//Imagenes/LoginCandado.png" alt=""><br>
                    
                    <label for="">Usuario<font color="red">*</font></label><br>
                    <input type="email" name="correo_emp" id="" required><br><br>

                    <label for="">Contraseña<font color="red">*</font></label><br>
                    <input type="password" name="contra_emp" id="" required><br><br>
                    <hr>

                    <input class="bg-primary" type="submit" value="LOGIN" name="empleado">
                ...
                <?php
                    ...
                    if(isset($_POST['empleado'])){
                        ...
                        $emp_correo=$_POST['correo_emp'];
                        $emp_contra=$_POST['contra_emp'];

                        if($emp_correo=='empleado@avan.com' && $emp_contra=='avan123'){
                            echo '<script>window.location="paginaCitasEmp.php"</script>';
                        }else{
